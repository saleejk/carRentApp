...
part of 'adddetailss.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class AddDetailsModelAdapter extends TypeAdapter<AddDetailsModel> {
  @override
  final int typeId = 2;

  @override
  AddDetailsModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AddDetailsModel obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.name)
  ...
  bool operator ==(Object other) =>
      ...
      other is AddDetailsModelAdapter &&
